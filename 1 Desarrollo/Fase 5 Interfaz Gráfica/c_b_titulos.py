...
class MainWindow(QMainWindow):
    ...
    def __init__(self, width, height, nombre, id, encriptacion):
        ...
        self.peliculas = pd.read_csv(BytesIO(self.encriptacion.cargar_csv("Datos_Cifrados/DatosPeliculasSeries_csv.enc", contexto="DatosPeliculasSeries_csv")))
        self.pun_com = pd.read_csv(BytesIO(self.encriptacion.cargar_csv(f"Datos_Cifrados/{id}_completo_csv.enc", contexto=f"{id}_completo_csv")))
        self.pun = pd.read_csv(BytesIO(self.encriptacion.cargar_csv(f"Datos_Cifrados/{id}_csv.enc", contexto=f"{id}_csv")))
    ...
    def puntuar(self, tid, Titulo_ES, nota):
        ...
        self.encriptacion.guardar_csv(f"Datos_Cifrados/{self.id}_completo_csv.enc", contexto=f"{self.id}_completo_csv")
        ...
        self.encriptacion.guardar_csv(f"Datos_Cifrados/{self.id}_csv.enc", contexto=f"{self.id}_csv")
