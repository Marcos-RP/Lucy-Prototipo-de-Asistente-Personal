...
class MainWindow(QMainWindow):
    ...
    def generacion_archivos(self, numero):
        self.encriptacion.guardar_json("Datos_Cifrados/users_json.enc", context="users_json")

        csv_header = "userId,Mi Nota,tid\n"
        self.encriptacion.datos_descifrados[f"Datos_Cifrados/{numero}_csv.enc"] = csv_header.encode()
        self.encriptacion.guardar_csv(f"Datos_Cifrados/{numero}_csv.enc", context=f"{numero}_csv")
        ...
        self.encriptacion.guardar_csv(f"Datos_Cifrados/{numero}_completo_csv.enc", context=f"{numero}_completo_csv")
